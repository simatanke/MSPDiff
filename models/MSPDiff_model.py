...
from MSPDiff.utils.base_model import BaseModel
from torch.nn import functional as F
from functools import partial
import numpy as np
from MSPDiff.utils.beta_schedule import make_beta_schedule, default
import sys

#sys.path.append('/mnt/workspace/HI-Diff')
from MSPDiff.utils.loss import init_loss
...
class MSPDiff(BaseModel):
    ...
    def optimize_parameters(self, current_iter):
        ...
        self.prior1 = self.net_le_dm(self.lq)
        ...
        if self.opt['train']['use_grad_clip']:
            torch.nn.utils.clip_grad_norm_(list(self.net_g.parameters()) + list(self.net_le_dm.parameters()), 0.01)
