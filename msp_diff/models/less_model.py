...
class less(BaseModel):
    """HI-Diff model for test."""

    def __init__(self, opt):
        super(less, self).__init__(opt)
    ...
    def p_mean_variance(self, x, t, clip_denoised=True, condition_x=None, ema_model=False):
        ...
        if ema_model:
            ...
            x_recon = self.predict_start_from_noise(x, t=t, noise=self.net_d(x, condition_x, torch.full(x.shape, t + 1,
        ...
        if self.opt['train']['use_grad_clip']:
            if self.apply_ldm:
                ...
                torch.nn.utils.clip_grad_norm_(
                    list(self.net_g.parameters()) + list(self.net_le_dm.parameters()) + list(self.net_d.parameters()),
                    0.01)
